...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/divinity099/DivinityZone")
UPSTREAM_REPO_BRANCH = os.environ.get(
    "UPSTREAM_REPO_BRANCH", "DivinityZone")
...
# Untuk Melihat Repo
REPO_NAME = os.environ.get("REPO_NAME") or "Ꭰɪᴠɪɴɪᴛʏ Ꮓᴏɴᴇ"
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/a41d4d4d1de4b1629a980.jpg"

# Default .helpme logo
HELP_LOGO = os.environ.get(
   "HELP_LOGO") or "https://telegra.ph/file/49e658baad2f60632e1e4.jpg"
...
GROUP_LINK = os.environ.get(
    "GROUP_LINK") or "t.me/NaughtySinceBirth"

# Default .repo Bot
OWNER_BOT = os.environ.get(
    "OWNER_BOT") or "t.me/Nikenihbos"
...
BOTLOG_MSG = os.environ.get(
    "BOTLOG_MSG") or "```DIVINITY ZONE AKTIF KONTOLL\n\nJika Tidak Bisa Di .ping\nSilahkan Anda\nCek viewlogs\nPada heroku Anda.\n```"
